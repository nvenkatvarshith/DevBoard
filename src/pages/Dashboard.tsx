...
function Dashboard(){
    ...
    const initialData:DevBoardState = {
            sprints: {
                "spr-001": {
                id: "spr-001",
    ...
    localStorage.setItem("devBoardState", JSON.stringify(initialData));
    const devState = JSON.parse(localStorage.getItem("devBoardState")|| "");
    const [devBoardState,setDevBoardState] = useState<DevBoardState>(devState);
    return (
